...
Uma classe Solution com a lógica da questão.

Uma função main() responsável por ler os dados de entrada.

A chamada do método da classe.

A impressão do resultado.
...
A quantidade total de trocas realizadas.
...
Todos os pares devem ficar antes dos ímpares.

Os pares devem ficar em ordem crescente.

Os ímpares devem ficar em ordem decrescente.
...
Configure o CMakeLists.txt para criar um executável para cada arquivo.

Selecione a questão desejada na configuração de execução.

Clique em Run.

Digite a entrada no console.
...
Vetor ordenado + quantidade de trocas
...
Vetor ordenado + quantidade de comparações

4

Bubble Sort adaptado

Pares crescentes antes de ímpares decrescentes
